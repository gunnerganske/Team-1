...
function makeDescriptionRequest(aProjId){ //initiate ajax request
    ...
    $.ajax('workbenchDBI.php',{ 
            ...
            success: function (descriptions){
                    ...
                    sendProjectData(aProjId,userid); //once the project description is loaded a second ajax funtion is called to pass info to the review form
            }
    });
}

function sendProjectData(projid){
